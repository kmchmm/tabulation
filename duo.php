            ...
            <div class="main-body">
                ...
                <table id="applicants">
                    ...
                    <?php
                        ...
                        $query = "SELECT * FROM duo WHERE judgename = '$loggedInUsername'";
                                            ...
                                            <div>
                                                <form class=" add-form" method="POST" action="actions.php" enctype="multipart/form-data">
                                                    <div class="form-handler">
                                                        ...
                                                        <div>
                                                            <input type="hidden" name="duoJudgeName" id="duoJudgeName" value="<?php echo $row['judgename'] ?>">
                                                        </div>
                                                        <div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="number" name="d2" id="d2" placeholder="Max of 50 points" value="<?php echo $row['vocals']?>">
                                                        </div>
                                                        <div>
                                                            <label for="">Expression (30 points)</label><br>
                                                            <input type="number" name="d3" id="d3" placeholder="Max of 30 points" value="<?php echo $row['expression']?>">
                                                        </div>
                                                        <div>
                                                            <label for="">Showmanship (20 points)</label><br>
                                                            <input type="number" name="d4" id="d4" placeholder="Max of 20 points" value="<?php echo $row['showmanship']?>">
                                                        </div>
                                                        <div>
