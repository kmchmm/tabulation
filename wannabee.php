...
<head>
    ...
    <title>Tabulation Wanna Bee</title>
</head>
<body>
    <div class="container">
        <header>
        ...
        <section class="">
            <div class="main-body">
                ...
                <table id="applicants">
                    <tr>
                        <th>House Name</th>
                        <th>Choreography <br> 40%</th>
                        <th>Execution <br> (Timing & Coordination, Projection & Expression)<br> 50%</th>
                        <th>Costume and Props <br> 10%</th>
                        <th>Actions</th>
                    </tr>
                    <?php

                        $loggedInUsername = $_SESSION['username'];
                        $query = "SELECT * FROM wannabee WHERE judgename = '$loggedInUsername'";
