...
<head>
    ...
    <title>Tabulation Video Montage</title>
</head>
<body>
    <div class="container">
        <header>
            ...
            <div class="main-body">
                ...
                <table id="applicants">
                    <tr>
                        <th>House Name</th>
                        <th>Content <br> 40%</th>
                        <th>Creativity <br> 30%</th>
                        <th>Editing Quality <br> 30%</th>
                        <th>Actions</th>
                    ...
                    <?php
                        ...
                        $query = "SELECT * FROM videomontage WHERE judgename = '$loggedInUsername'";
                                            ...
                                            <div>
                                                <form class=" add-form" method="POST" action="actions.php" enctype="multipart/form-data">
                                                    <div class="form-handler">
                                                        ...
                                                        <div>
                                                            <input type="hidden" name="vmJudgeName" id="vmJudgeName" value="<?php echo $row['judgename'] ?>">
                                                        </div>
                                                        <div>
